...
export default function PrivateAdminConsole() {
    ...
    {regionalCandidates.map((cand) => (
        <div key={cand.candidateId} style={{ background: '#0d1117', border: '1px solid #30363d', padding: '15px', borderRadius: '4px' }}>
            ...
            <div style={{ fontSize: '11px', color: '#8b949e', marginTop: '2px' }}>ID: <span style={{ color: '#58a6ff' }}>{cand.candidateId}</span></div>
        </div>
    ))}
</div>
                        )}
